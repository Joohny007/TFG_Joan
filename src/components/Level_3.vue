        ...
        data() {
            return {
                boxData: [
                    ...
                    { id:3, value: "Evitar cenar tarde por la noche", show: false },
                    ...
                    { id:7, value: "Evitar siestas durante el dia", show: false },
                    ...
                    { id:11, value: "Evitar sustancias que alteren el sueño (alcohol, cafeína, nicotina)", show: false },
                    { id:12, value: "Propiciar un buen entorno para el sueño (oscuro, fresco, tranquilo)", show: false },
                ],
                currVal: null,
                result: '',
                correctMatches: []
