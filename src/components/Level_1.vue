        ...
        methods: {
            ...
            if(this.getList1(12).length != 0 && this.getList1(13).length != 0){
                if(this.getList1(13)[0].id == 11){
                    document.getElementById(13).classList.add('right')
                    correctAns += 1

                }else{
                    document.getElementById(13).classList.add('wrong')
                    wrongAns += 1
                }
            
                if(this.getList1(12)[0].id == 14){
                    document.getElementById(12).classList.add('right')
                    correctAns += 1

                }else{
                    document.getElementById(12).classList.add('wrong')
                    wrongAns += 1
                }
          ...
          verification1_2: function(){
            ...
            if(this.getList2(2).length != 0 && this.getList2(3).length != 0 && this.getList2(4).length != 0){
                if(this.getList2(3)[0].id == 0){
                    document.getElementById(3).classList.add('right')
                    correctAns += 1

                }else{
                    document.getElementById(3).classList.add('wrong')
                    wrongAns += 1
                }

                if(this.getList2(2)[0].id == 2){
                    document.getElementById(2).classList.add('right')
                    correctAns += 1

                }else{
                    document.getElementById(2).classList.add('wrong')
                    wrongAns += 1
                }
                if(this.getList2(4)[0].id == 4){
                    document.getElementById(4).classList.add('right')
                    correctAns += 1

                }else{
                    document.getElementById(4).classList.add('wrong')
                    wrongAns += 1
                }
